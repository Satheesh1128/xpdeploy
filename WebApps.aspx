<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterApp.master" AutoEventWireup="true"
    CodeFile="WebApps.aspx.cs" Inherits="WebApps" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-12 HTB SecondMenu">
        ...
        <asp:DropDownList ID="BindServer" runat="server" CssClass="HTB ddl"
            AutoPostBack="true" OnSelectedIndexChanged="BindServer_SelectedIndexChanged"   Visible="false">
        ...
        <asp:DropDownList ID="BindClient" runat="server" CssClass="HTB ddl"
            AutoPostBack="true" OnSelectedIndexChanged="BindClient_SelectedIndexChanged">           
        </asp:DropDownList>
