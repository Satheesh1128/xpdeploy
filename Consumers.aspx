<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterApp.master" AutoEventWireup="true"
    CodeFile="Consumers.aspx.cs" Inherits="Consumers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-12 HTB SecondMenu">
        ...
        <asp:DropDownList ID="BindActiveStatus" runat="server" CssClass="HTB ddl" AutoPostBack="true" OnSelectedIndexChanged="BindActiveStatus_SelectedIndexChanged">
        ...
        <asp:Button ID="Button1" runat="server" Text="Edit" class="HTB btns bd1" Visible="false" OnClick="Button1_Click"></asp:Button>
        <asp:Button ID="Add" runat="server" Text="Add" class="HTB btns bd1" Visible="false" OnClick="Add_Click"></asp:Button>
    </div>
