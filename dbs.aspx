<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterApp.master" AutoEventWireup="true"
    CodeFile="dbs.aspx.cs" Inherits="dbs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-12 HTB SecondMenu">
        ...
        <asp:DropDownList ID="BindENVLists" runat="server" CssClass="HTB ddl" AppendDataBoundItems ="true"
        ...
        <asp:DropDownList ID="Version" runat="server" CssClass="HTB ddl"
            ...
            <asp:ListItem>RT60</asp:ListItem>
        </asp:DropDownList>
