...
public partial class ml : System.Web.UI.Page
{
    ...
    protected void BindServer1()
    {
        ...
        {
            cn.Open();
            SqlCommand cm = new SqlCommand("SELECT ServerName FROM ServerMaster", cn);
            SqlDataAdapter da = new SqlDataAdapter(cm);
            da.Fill(bs);
            ...
            BindServer.DataBind();
            BindServer.Items.Insert(0, new ListItem("--Server--"));
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Masters_SELECT", cn);
            cmd.Connection = cn;
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            cmd.Parameters.AddWithValue("@Masterselect", Masterselect.Text);
            cmd.Parameters.AddWithValue("@ENV", BindENV.Text);
            cmd.Parameters.AddWithValue("@Search", Search.Text);
            cmd.Parameters.AddWithValue("@Server", BindServer.Text);
    ...
    {
        if (Masterselect.Text == "Servers" || Masterselect.Text == "ServerList")
        {
            BindServer.Visible = true;
        }
        else
        {
            BindServer.Visible=false;
        }
        BindServer1();        
        BindHtmlTable();
    ...
    protected void Masterselect_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (Masterselect.Text == "ServerList")
        {
            BindServer.Visible = true;
        }
        else
    ...
    protected void Add_Click(object sender, EventArgs e)
    {
        ...
        {
            //Session["cm_ID"] = "";
            Session["Masterselect"] = Masterselect.Text;
            //Response.Redirect("mle.aspx");
            BindRolePermission();
        }
    ...
    protected void GoAppsAddEdit()
    {
        ...
        String reponsepage = "ml.aspx";
        String reponsegopage = "mle.aspx";
