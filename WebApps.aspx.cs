...
public partial class WebApps : System.Web.UI.Page
{
    ...
    protected void BindApplicationList()
    {
        ...
        {
            cn.Open();
            SqlCommand cm = new SqlCommand(DropDownFilters.DropDownList.WebApps, cn);
    ...
    protected void BindClient1()
    {
        ...
        {
            cn.Open();
            SqlCommand cm = new SqlCommand("SELECT ClientName FROM ClientMaster CM INNER JOIN ENVMaster EM WITH(NOLOCK) ON CM.ENVID = EM.ID WHERE ENVName = '" + BindENV.Text + "'", cn);
            SqlDataAdapter da = new SqlDataAdapter(cm);
            da.Fill(bc);
    ...
    protected void BindENV1()
    {
        ...
        {
            cn.Open();
            SqlCommand cm = new SqlCommand("SELECT ENVName FROM ENVMaster ORDER BY ID ASC", cn);
            SqlDataAdapter da = new SqlDataAdapter(cm);
            da.Fill(be);
    ...
    private DataTable GetData()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("Urls_SELECT", cn);
            cmd.Connection = cn;
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    protected void ExportExcel()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Urls_" + DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss") + ".xlsx");
    ...
    protected void Edit_Click(object sender, EventArgs e)
    {
        ...
        //    Response.Redirect("WebAppsE.aspx");
        //}
    ...
    protected void GoAppsAddEdit()
    {
        ...
        String reponsepage = "WebApps.aspx";
        String reponsegopage = "WebAppse.aspx";
