<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterApp.master" AutoEventWireup="true"
    CodeFile="ml.aspx.cs" Inherits="ml" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-12 HTB SecondMenu">
        ...
        <asp:DropDownList ID="Masterselect" runat="server" CssClass="HTB ddl"
            AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="Masterselect_SelectedIndexChanged"> 
            <asp:ListItem>Environments</asp:ListItem>          
            <asp:ListItem>Clients</asp:ListItem>
            <asp:ListItem>Servers</asp:ListItem>
            <asp:ListItem>ServerList</asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="BindServer" runat="server" CssClass="HTB ddl" Visible="false"
            AutoPostBack="true"  OnSelectedIndexChanged="BindServer_SelectedIndexChanged"> 
            <asp:ListItem></asp:ListItem>          
        </asp:DropDownList>

        <asp:DropDownList ID="BindENVLists" runat="server" CssClass="HTB ddl" Visible="false"
            AutoPostBack="true"  OnSelectedIndexChanged="BindENVLists_SelectedIndexChanged"> 
            <asp:ListItem></asp:ListItem>          
        </asp:DropDownList>

        <asp:DropDownList ID="Version" runat="server" CssClass="HTB ddl" Visible="false"
        ...
        <asp:DropDownList ID="BindStatus" CssClass="HTB ddl" runat="server" Visible="true" OnSelectedIndexChanged="BindStatus_SelectedIndexChanged"
            AutoPostBack="true">
        </asp:DropDownList>

        <asp:TextBox ID="Search" CssClass="HTB Textboxdesign" runat="server" placeholder="--Name--" AutoPostBack="true"  OnTextChanged="Search_TextChanged"></asp:TextBox>
